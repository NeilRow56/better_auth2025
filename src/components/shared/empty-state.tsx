...
export function EmptyState({ description, title, className }: iAppProps) {
  return (
    <div className='animate-fadeIn flex flex-col items-center justify-center rounded-md border-2 border-dashed p-8 text-center'>
